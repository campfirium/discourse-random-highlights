...
if (!scss.includes("calc(100% - 0.12em)") || !scss.includes("padding: 0 0.05em 0.15em")) {
...
if (!scss.includes("calc(#{$highlight_light_opacity} * 100%)") || !scss.includes("min(calc(#{$highlight_dark_opacity} * 278%), 50%)")) {
